...
(* type ty = Int | Bool | Float | Char | String | Struct of string | List of ty | Arrow of ty list * ty *)
...
let rec string_of_typ = function
  ...
  | Arrow (lst, ty) -> 
     String.concat ""  ["Arrow(" ;
     String.concat "," (List.map string_of_typ lst) ;
     "," ;
      string_of_typ ty;
      ")"
     ]
  | StructShape _ -> "Struct shape(not implemented"
